...
public class StrategieSniper implements StrategieFighter{
    ...
    public void combat(ChampDeBataille champ,Fighter Fighter){
        ...
        if(Fighter.getMinution()[2]>0){
            ...
            this.deplacement(champ, Fighter);
                ...
                this.placerMine(champ, Fighter);
            }
        }
    }

    public void placerMine(ChampDeBataille champ,Fighter c){
